      ...
      <div className="container-corporate">
          ...
          {RESULTADOS_ITEMS.map((item) => (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <TrendingUp className="w-4 h-4 text-slate-400 group-hover:text-[#0052CC] transition-colors" />
              </div>
        ...
        <div className="bg-[#051C2C] text-white p-8 rounded-2xl border border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-6 text-center shadow-xl">
          <div className="p-4 border-b md:border-b-0 md:border-r border-slate-800">
            <div className="text-3xl sm:text-4xl font-black text-[#38BDF8] font-mono mb-1">-30%</div>
          ...
          <div className="p-4 border-b md:border-b-0 md:border-r border-slate-800">
            <div className="text-3xl sm:text-4xl font-black text-[#00A3E0] font-mono mb-1">+60%</div>
